...
var FACTORY_ADDRESS = '0xa430c9549A6F30D11C1d0aA2E193Faf512Cc9af2';
var INIT_CODE_HASH = '0xa214758cce75f2fe626fa13e0764d8aac8a4fd6295a93b3f1502beb3a28c94f2';
...
var WONE = (_WONE = {}, _WONE[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WONE', 'Wrapped One'), _WONE[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0x807b8da767a712ec2f3ba6817981ea49d5f76b9b', 18, 'WONE', 'Wrapped One'), _WONE);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER && pairs[0].involvesToken(WONE[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER && pairs[pairs.length - 1].involvesToken(WONE[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WONE[pairs[0].chainId]];
 ...
 * In other words, if the currency is ETHER, returns the WONE token amount for the given chain. Otherwise, returns
 * the input currency amount.
 */

function wrappedAmount(currencyAmount, chainId) {
  if (currencyAmount instanceof TokenAmount) return currencyAmount;
  if (currencyAmount.currency === ETHER) return new TokenAmount(WONE[chainId], currencyAmount.raw);
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === ETHER) return WONE[chainId];
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}
/**
...
var HMY_RPC_URL = 'https://api.s0.b.hmny.io';

var Web3 = /*#__PURE__*/require('web3');

var web3 = /*#__PURE__*/new Web3(HMY_RPC_URL);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (provider === undefined) provider = new Web3Provider(web3);
...
export { ChainId, Currency, CurrencyAmount, ETHER, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WONE, currencyEquals, inputOutputComparator, tradeComparator };
//# sourceMappingURL=openswap-sdk.esm.js.map

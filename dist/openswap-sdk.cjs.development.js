...
var IUniswapV2Pair = _interopDefault(require('openswap-core/build/contracts/IUniswapV2Pair.json'));
...
var WONE = (_WONE = {}, _WONE[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WONE', 'Wrapped One'), _WONE[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0x807b8da767a712ec2f3ba6817981ea49d5f76b9b', 18, 'WONE', 'Wrapped One'), _WONE);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER && pairs[0].involvesToken(WONE[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER && pairs[pairs.length - 1].involvesToken(WONE[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (provider === undefined) provider = new providers.Web3Provider(web3);
...
//# sourceMappingURL=openswap-sdk.cjs.development.js.map
